...
const ProjectDetailModal: React.FC<ProjectDetailModalProps> = ({ project, onClose, isOpen }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-slate-800/70 backdrop-blur-lg text-slate-200 rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col border border-slate-700 overflow-hidden"
      ...
      >
        ...
        {/* Footer */}
        <div className="p-5 border-t border-slate-700 flex justify-end sticky bottom-0 bg-slate-800/70 backdrop-blur-lg">
          {project.url !== "N/A" && (
            <a
              href={project.url}
              target="_blank"
