...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, onOpenModal, onToggleBookmark }) => {
  ...
  return (
    <div className="bg-slate-800/70 backdrop-blur-lg shadow-xl rounded-xl p-5 flex flex-col justify-between transition-all duration-300 border border-slate-700 hover:border-teal-500/80 hover:shadow-teal-500/30 transform hover:-translate-y-1.5 group">
      <div>
